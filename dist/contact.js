...
/* harmony import */ var _animations_zoom_out_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animations/zoom-out-scroll */ "./src/scripts/animations/zoom-out-scroll.js");
...
masterTimeline.add(_animations_zoom_out_scroll__WEBPACK_IMPORTED_MODULE_1__.zoomOutScroll).add(_animations_fade_in_up__WEBPACK_IMPORTED_MODULE_2__.fadeInUpScrollTrigger);
var contactTitle = split_type__WEBPACK_IMPORTED_MODULE_0__["default"].create('#contact__title', {
  absolute: true
});
var contactLoader = gsap__WEBPACK_IMPORTED_MODULE_3__["default"].timeline();
contactLoader.to('.char', {
  y: 0,
  stagger: 0.05,
  delay: 0.2,
  duration: 0.1,
  ease: 'POWER3',
  opacity: 1
}).fromTo(".contact-hero__image", {
  yPercent: -100
}, {
  duration: 2,
  yPercent: 0,
  ease: "slow"
}).fromTo(".contact-hero__image img", {
  yPercent: 100
}, {
  duration: 2,
  yPercent: 0,
  ease: "slow"
}, "<").fromTo(".contact-header__text", {
  opacity: 0,
  y: 30
}, {
  opacity: 1,
...
gsap__WEBPACK_IMPORTED_MODULE_3__["default"].from(".footer__link", {
  scrollTrigger: {
